package runtime.engine.infrastructure.external.registry;
...
public interface AgentRegistry {
    ...
    void register(AgentProperties.AgentCardInfo agentCardInfo);
    ...
    default void register(AgentCard agentCard) {
        ...
        AgentProperties.AgentCardInfo agentCardInfo = convertToAgentCardInfo(agentCard);
     ...
     */
    default AgentProperties.AgentCardInfo convertToAgentCardInfo(AgentCard agentCard) {
        AgentProperties.AgentCardInfo info = new AgentProperties.AgentCardInfo();
        ...
        // 设置capabilities
        AgentProperties.Capabilities capabilities = new AgentProperties.Capabilities();
        ...
        // 设置技能
        List<AgentProperties.Skill> skills = agentCard.skills().stream()
                .map(skill -> {
                    AgentProperties.Skill configSkill = new AgentProperties.Skill();
