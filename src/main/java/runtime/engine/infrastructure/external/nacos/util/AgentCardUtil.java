package runtime.engine.infrastructure.external.nacos.util;
...
public class AgentCardUtil {
    ...
    public static AgentCard transferFromAgentCardInfo(AgentProperties.AgentCardInfo agentCardInfo) {
    ...
    public static AgentCapabilities transferFromAgentCardInfoCapabilities(
            AgentProperties.Capabilities capabilities) {
    ...
    public static List<AgentSkill> transferFromAgentCardInfoSkills(List<AgentProperties.Skill> skills) {
